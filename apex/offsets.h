...
#define OFFSET_ENTITYLIST		    0x19224d8 		//0x18da338		//cl_entitylist
#define OFFSET_LOCAL_ENT			0x1cd1d58  		//0x1c898f8		//LocalPlayer d
...
#define OFFSET_VISIBLE_TIME         0x1ACC          //m_visibletime  0x1650 try this if it doesnt work
...
#define GLOW_TYPE 0x2C0 //0x2C4 //OK Script_Highlight_GetState + 4 / m_highlightFunctionBits + 4?
...
#define OFFSET_CLIENTSTATE			0x12af8d0
#define OFFSET_SIGNONSTATE			0x12bf738 
